...
def filter_results(results, lang="en"):
    ...
    banned_url_terms = ["/jobs/search", "/remote-brazil-jobs", "linkedin.com/jobs/search"]
    ...
    ptbr_banned_body_terms = ["vagas encerradas", "inscrições encerradas", "canditaturas encerradas"]
